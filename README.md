...
Peer-Graded Assignment: Building a dashboard with Cognos Dashboard Embedded (CDE)
...
Download the 2 files m5_survey_data_demographics.csv and m5_survey_data_technologies_normalised.csv. Upload these 2 CSV files as data assets to your project in CDE.
...
To get the Permanent link of read-only view of the dashboard, follow instructions below:

On the application toolbar of your dashboard page, click Share icon.


Click on the toggle button to turn on “Share with anyone who has the link”.

Click on the copy link icon to copy the “Permanent link to view the dashboard”. This link always points to the most recent version of your dashboard. This link will be required to submit for your assignment to be graded.
...
Have you provided permanent read-only view CDE link which opens your valid Cognos dashboard?
